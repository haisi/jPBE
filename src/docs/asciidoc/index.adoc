...
|===
|https://github.com/haisi/jPBE[*Source code*] |http://selman.li/jPBE/javadoc[*JavaDoc*]|https://github.com/haisi/jPBE/blob/master/LICENSE[*License*]|https://selman.li/thesis[*Bachelor's thesis this project is based on*]
|===
